...
#ifndef SERVICE_INSTALL_STEP_H
#define SERVICE_INSTALL_STEP_H
...
class Task;
class ServiceInstallStep : public Step
{
public:
    //! Constructor
    ServiceInstallStep();
...
protected:
    ...
    void onInstallServiceComplete(bool success, std::string errorText);
