...
public:
    ...
    bool onRemoveManifest(pbnjson::JValue result, void *user_data,
...
protected:
     ...
     */
    bool generateUnifiedAppRoleFile(const std::string &path,
    ...
    bool generateUnifiedAppPermissionsFile(const std::string &path, bool verified,
